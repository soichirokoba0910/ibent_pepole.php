...
<body>
  ...
  <div id ="main">
    <form method="POST" action="">
      <p>ライブ名</p>
      <input type="text" name="raibu" value="<?php  if($_POST) echo $_POST['raibu'] ?>">
      <p>ライブＩＤ</p>
      <input type="text" name="raibuid" value="<?php  if($_POST) echo $_POST['raibuid'] ?>">
      <br>
      <?php  if($_POST){
        if(empty($_POST['raibu'])||empty($_POST['raibuid'])){
          echo "※入力されてません";
        }
      } ?>
      <div class="sub">
